...
namespace FingerHandGesture
{
    public class KinectTracker
    {
        ...
        public void depthFrameReady(object sender, DepthImageFrameReadyEventArgs e)
        {
            ...
            // Return a 0 or 1 matrix, which contains with pixels are near enough
            ...
            //if (hands.Count > 0)
            //{
            //    System.Console.WriteLine("Hand-1 has " + hands[0].fingertips.Count.ToString() + " fingers");

            //}
            //if (hands.Count > 1)
            //{
            //    System.Console.WriteLine("Hand-2 has " + hands[1].fingertips.Count.ToString() + " fingers");
            //}
